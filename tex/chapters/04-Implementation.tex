...
\subfloat[Numerical Fingerprint]{\includegraphics[width = 0.5\textwidth]{../img/Numerical/Tit_For_Tat.png}}
...
\subfloat[Numerical Fingerprint]{\includegraphics[width = 0.5\textwidth]{../img/Numerical/Anti_Tit_For_Tat.png}}
...
\subfloat[Numerical Fingerprint]{\includegraphics[width = 0.5\textwidth]{../img/Numerical/Win_Stay_Lose_Shift.png}}
...
\subfloat[Numerical Fingerprint]{\includegraphics[width = 0.5\textwidth]{../img/Numerical/Cooperator.png}}
...
\subfloat[Numerical Fingerprint]{\includegraphics[width = 0.5\textwidth]{../img/Numerical/Defector.png}}
...
For example, the Fingerprint documentation in Axelrod-Python (\url{http://axelrod.readthedocs.io/en/latest/tutorials/further_topics/fingerprinting.html}) contains short code snippets beside a preview of the expected output.
...
All lines beginning with \mintinline{rst}{>>>} are executed as python code and the result is checked against the next line.
...
% That's equivalent to describing your code contribution as "we have it and it's awesome".

% I suggest showing snippets of http://axelrod.readthedocs.io/en/latest/tutorials/further_topics/fingerprinting.html (both the rendered html and the rst, saying what rst is etc...).

% Discuss the doctests (in the same way that you've discussed the unit tests).

% You could also download a pdf version of the docs: http://readthedocs.org/projects/axelrod/downloads/pdf/latest and grab the one page corresponding to fingerprinting and include that as an appendix.

% You could possibly also find a comment/requests on the PR (if one exists) about the documentation perhaps?
