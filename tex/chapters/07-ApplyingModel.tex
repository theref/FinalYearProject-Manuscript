...
Again this is encouraging as the strategies are identical except that one begins with a Cooperation and the other begins with a Defection.
...
In Figure \ref{fig:nbh_pi_e}, the strategies $\pi$ and $e$ are connect.
...
Interestingly, there is a third strategy of this form implemented in Axelrod-Pythoh, $\phi$.
The screenshot in Figure \ref{fig:ss_pi_phi_e} shows the documentation for these strategies, including an approximation of the ratio they attempt to replicate.
