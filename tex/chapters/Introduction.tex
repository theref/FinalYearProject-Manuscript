...
The Prisoner's Dilemma (PD) is a classical model in Game Theory and in \cite{Bendor1991} it is stated that ``few works in social science have had the general impact of [Axelrod’s study of the evolution of cooperation]''.
It is widely used to demonstrate emergent cooperative behaviours in populations of selfishly acting agents and is often used to model biological systems \cite{Nowak2003}, as well as systems in sociology \cite{Houston2000}, psychology \cite{Roy2000}, and economics \cite{Hemesath1994}.
