...
\begin{figure}[htbp!]
\subfloat[Exact analytical fingerprint]{\includegraphics[width = 0.8\textwidth]{../img/screenshots/ScreenShot1.png}}
\subfloat[Exact analytical fingerprint]{\includegraphics[width = 0.8\textwidth]{../img/screenshots/ScreenShot2.png}}
\subfloat[Exact analytical fingerprint]{\includegraphics[width = 0.8\textwidth]{../img/screenshots/ScreenShot3.png}}
\subfloat[Exact analytical fingerprint]{\includegraphics[width = 0.8\textwidth]{../img/screenshots/ScreenShot4.png}}
