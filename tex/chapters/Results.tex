...
\begin{figure}[htbp!]
\centering
\subfloat[Defector]{\includegraphics[width = 0.3\textwidth]{../img/Numerical/Defector.png}}\\[-2ex]

\subfloat[Random(0.1) - will cooperate\protect\\10\% of the time]{\includegraphics[width = 0.3\textwidth]{../img/Numerical/Random01.png}}
...
\subfloat[Random(0.8) - will cooperate\protect\\90\% of the time]{\includegraphics[width = 0.3\textwidth]{../img/Numerical/Random09.png}}\\

\subfloat[Cooperator]{\includegraphics[width = 0.3\textwidth]{../img/Numerical/Cooperator.png}}
...
\subfloat[GoByMajority with memory depth infinite]{\includegraphics[width = 0.5\textwidth]{../img/Numerical/Go_By_Majority0.png}}
\end{figure}
...
For two strategies $A$ and $B$ where $s_{x, y}^{(A)}$ is the score for strategy $A$ at point $x, y$, we can compute a rudimentary value of `similarity' by calculating:
$$
...
This is shown in Figure \ref{fig:sum_squares}.

\begin{figure}[htbp!]
    \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{../img/sum_squares.png}}
