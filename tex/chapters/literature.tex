...
TitForTat is a very simple strategy (see Section \ref{sec:individual_strategies}) and as explained in \cite{Axelrod1980b}, it won because of three defining characteristics:
...
The paper claims that Gradual performs better than TitForTat %TODO confirmed by Axelrod-Python??
